...
import { MapPin, Banknote, Clock, GraduationCap, Users, ArrowUpRight, CheckCircle2 } from 'lucide-react';
      ...
      <div className="p-4 pt-3 bg-slate-50/80 border-t border-slate-100 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 text-xs font-semibold text-slate-700 hover:text-red-900 hover:bg-slate-200/80 rounded-lg transition-colors flex items-center gap-1 cursor-pointer"
          >
            <span>Details</span>
          ...
          <button
            ...
            className="px-3.5 py-1.5 bg-red-900 hover:bg-red-800 text-white text-xs font-bold rounded-lg shadow-xs hover:shadow-md transition-all cursor-pointer"
          >
            I'm Interested
          </button>
        </div>
